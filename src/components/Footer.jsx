        ...
        <Row>
          <Col lg={6} sm={24} xs={24}>
            <div className="footer-center">
              ...
              <div>
                <a target="_blank " rel="noreferrer" href="http://ant.design">
                  Ant Design
                </a>
              </div>
              <div>
          ...
          <Col lg={6} sm={24} xs={24}>
            <div className="footer-center">
              ...
              <div>
                <a target="_blank" rel="noreferrer" href="http://ux.ant.design">
                  Ant UX
                </a>
                <span> - </span>
                <span>页面逻辑素材</span>
          ...
          <Col lg={6} sm={24} xs={24}>
            <div className="footer-center">
              ...
              <div>
                <a target="_blank" rel="noreferrer" href="https://eggjs.org/">
                  Egg
                </a>
                <span> - </span>
